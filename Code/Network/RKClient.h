...
/**
 * Remove an HTTP header from each request dispatched through the Rest client
 */
...
- (RKRequest*)post:(NSString*)resourcePath params:(NSObject<RKRequestSerializable>*)params delegate:(NSObject<RKRequestDelegate>*)delegate shouldLog:(BOOL)shouldLog;
